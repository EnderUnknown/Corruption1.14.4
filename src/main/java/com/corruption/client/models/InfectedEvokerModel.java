...
@OnlyIn(Dist.CLIENT)
public class InfectedEvokerModel<T extends InfectedEvoker> extends EntityModel<T> implements IHasArm, IHasHead {
   ...
   public InfectedEvokerModel(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
