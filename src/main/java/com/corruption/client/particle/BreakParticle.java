package com.corruption.client.particle;
...
@OnlyIn(Dist.CLIENT)
public class BreakParticle extends SpriteTexturedParticle {
   private final float field_217571_C;
   private final float field_217572_F;

   private BreakParticle(World p_i47644_1_, double p_i47644_2_, double p_i47644_4_, double p_i47644_6_, double p_i47644_8_, double p_i47644_10_, double p_i47644_12_, ItemStack p_i47644_14_) {
   ...
   protected BreakParticle(World p_i47645_1_, double p_i47645_2_, double p_i47645_4_, double p_i47645_6_, ItemStack p_i47645_8_) {
   ...
   @OnlyIn(Dist.CLIENT)
   public static class InfectedSlimeFactory implements IParticleFactory<BasicParticleType> {
      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         return new BreakParticle(worldIn, x, y, z, new ItemStack(ItemRegistry.CURSED_SLIME));
      }
   }
}