...
public class MagmaPistonHeadBlock extends DirectionalBlock {
   ...
   public MagmaPistonHeadBlock(Block.Properties properties) {
      super(properties);
      ...
      this.setRegistryName("magmapiston_head");
   }
   ...
   public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
      if (!worldIn.isRemote && player.abilities.isCreativeMode) {
         ...
         if (block == BlockRegistry.MAGMASTICKY_PISTON || block == BlockRegistry.MAGMAPISTON) {
   ...
   public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
      if (state.getBlock() != newState.getBlock()) {
         ...
         if ((blockstate.getBlock() == BlockRegistry.MAGMAPISTON|| blockstate.getBlock() == BlockRegistry.MAGMASTICKY_PISTON) && blockstate.get(MagmaPiston.EXTENDED)) {
   ...
   public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
      ...
      return block == BlockRegistry.MAGMAPISTON || block == BlockRegistry.MAGMASTICKY_PISTON || block == BlockRegistry.MAGMAMOVINGPISTON;
   }
   ...
   public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
      return new ItemStack(state.get(TYPE) == PistonType.STICKY ? BlockRegistry.MAGMASTICKY_PISTON : BlockRegistry.MAGMAPISTON);
   }
